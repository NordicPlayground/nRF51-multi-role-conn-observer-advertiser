 ...
 * @date     20. August 2012
 *
 * @note     Generated with SVDConv V2.77c 
 *           from CMSIS SVD File 'nRF51.xml' Version 2.0,
 *******************************************************************************************************/
...
typedef struct {                                    /*!< POWER Structure                                                       */
  ...
  __I  uint32_t  PERRDY;                            /*!< Periferal on/off status.                                              */
  __I  uint32_t  RESERVED4[62];
  __O  uint32_t  SYSTEMOFF;                         /*!< System off register.                                                  */
  __IO uint32_t  PERPOWER;                          /*!< Peripheral power configuration.                                       */
  ...
  __IO uint32_t  RESET;                             /*!< Reset functionality configuration register. This register is
                                                         a retained register.                                                  */
...
typedef struct {                                    /*!< RADIO Structure                                                       */
  ...
  __IO uint32_t  INTENCLR;                          /*!< Interrupt enable clear register.                                      */
  __I  uint32_t  RESERVED3[61];
  __IO uint32_t  CRCSTATUS;                         /*!< CRC status register.                                                  */
...
typedef struct {                                    /*!< UART Structure                                                        */
  ...
  __IO uint32_t  RXD;                               /*!< RXD register.                                                         */
...
typedef struct {                                    /*!< TIMER Structure                                                       */
  ...
  __O  uint32_t  TASKS_CLEAR;                       /*!< Clear time (clear CC0 in counter mode).                               */
...
typedef struct {                                    /*!< RNG Structure                                                         */
  ...
  __IO uint32_t  VALUE;                             /*!< RNG random number.                                                    */
} NRF_RNG_Type;
...
typedef struct {                                    /*!< ECB Structure                                                         */
  ...
  __IO uint32_t  EVENTS_ERRORECB;                   /*!< ECB block encrypt aborted due to a STOPECB task or a higher
                                                         priority CCM encryption.                                              */
...
typedef struct {                                    /*!< CCM Structure                                                         */
  ...
  __IO uint32_t  UPPTR;                             /*!< Pointer to unencrypted packet.                                        */
  __IO uint32_t  EPPTR;                             /*!< Pointer to encrypted packet.                                          */
  __IO uint32_t  SCRATCHPTR;                        /*!< Pointer to "scratch" data area used for temporary storage during
...
/*__I  uint32_t  READY;*/                           /*!< Ready flag.                                                           */
  __IO uint32_t  READY;                             /*!< Ready flag (RW)                                                      */
...
typedef struct {                                    /*!< PPI Structure                                                         */
  __O  uint32_t  TASKS_CHG0EN;                      /*!< Enable channel group 0.                                               */
  __O  uint32_t  TASKS_CHG0DIS;                     /*!< Disable channel group 0.                                              */
  __O  uint32_t  TASKS_CHG1EN;                      /*!< Enable channel group 1.                                               */
  __O  uint32_t  TASKS_CHG1DIS;                     /*!< Disable channel group 1.                                              */
  __O  uint32_t  TASKS_CHG2EN;                      /*!< Enable channel group 2.                                               */
  __O  uint32_t  TASKS_CHG2DIS;                     /*!< Disable channel group 2.                                              */
  __O  uint32_t  TASKS_CHG3EN;                      /*!< Enable channel group 3.                                               */
  __O  uint32_t  TASKS_CHG3DIS;                     /*!< Disable channel group 3.                                              */
  ...
  __I  uint32_t  RESERVED1;
  __IO uint32_t  CH0_EEP;                           /*!< Channel 0 event end-point.                                            */
  __IO uint32_t  CH0_TEP;                           /*!< Channel 0 task end-point.                                             */
  __IO uint32_t  CH1_EEP;                           /*!< Channel 1 event end-point.                                            */
  __IO uint32_t  CH1_TEP;                           /*!< Channel 1 task end-point.                                             */
  __IO uint32_t  CH2_EEP;                           /*!< Channel 2 event end-point.                                            */
  __IO uint32_t  CH2_TEP;                           /*!< Channel 2 task end-point.                                             */
  __IO uint32_t  CH3_EEP;                           /*!< Channel 3 event end-point.                                            */
  __IO uint32_t  CH3_TEP;                           /*!< Channel 3 task end-point.                                             */
  __IO uint32_t  CH4_EEP;                           /*!< Channel 4 event end-point.                                            */
  __IO uint32_t  CH4_TEP;                           /*!< Channel 4 task end-point.                                             */
  __IO uint32_t  CH5_EEP;                           /*!< Channel 5 event end-point.                                            */
  __IO uint32_t  CH5_TEP;                           /*!< Channel 5 task end-point.                                             */
  __IO uint32_t  CH6_EEP;                           /*!< Channel 6 event end-point.                                            */
  __IO uint32_t  CH6_TEP;                           /*!< Channel 6 task end-point.                                             */
  __IO uint32_t  CH7_EEP;                           /*!< Channel 7 event end-point.                                            */
  __IO uint32_t  CH7_TEP;                           /*!< Channel 7 task end-point.                                             */
  __IO uint32_t  CH8_EEP;                           /*!< Channel 8 event end-point.                                            */
  __IO uint32_t  CH8_TEP;                           /*!< Channel 8 task end-point.                                             */
  __IO uint32_t  CH9_EEP;                           /*!< Channel 9 event end-point.                                            */
  __IO uint32_t  CH9_TEP;                           /*!< Channel 9 task end-point.                                             */
  __IO uint32_t  CH10_EEP;                          /*!< Channel 10 event end-point.                                           */
  __IO uint32_t  CH10_TEP;                          /*!< Channel 10 task end-point.                                            */
  __IO uint32_t  CH11_EEP;                          /*!< Channel 11 event end-point.                                           */
  __IO uint32_t  CH11_TEP;                          /*!< Channel 11 task end-point.                                            */
  __IO uint32_t  CH12_EEP;                          /*!< Channel 12 event end-point.                                           */
  __IO uint32_t  CH12_TEP;                          /*!< Channel 12 task end-point.                                            */
  __IO uint32_t  CH13_EEP;                          /*!< Channel 13 event end-point.                                           */
  __IO uint32_t  CH13_TEP;                          /*!< Channel 13 task end-point.                                            */
  __IO uint32_t  CH14_EEP;                          /*!< Channel 14 event end-point.                                           */
  __IO uint32_t  CH14_TEP;                          /*!< Channel 14 task end-point.                                            */
  __IO uint32_t  CH15_EEP;                          /*!< Channel 15 event end-point.                                           */
  __IO uint32_t  CH15_TEP;                          /*!< Channel 15 task end-point.                                            */
  __I  uint32_t  RESERVED2[156];
  __IO uint32_t  CHG0;                              /*!< Channel group 0.                                                      */
  __IO uint32_t  CHG1;                              /*!< Channel group 1.                                                      */
  __IO uint32_t  CHG2;                              /*!< Channel group 2.                                                      */
  __IO uint32_t  CHG3;                              /*!< Channel group 3.                                                      */
} NRF_PPI_Type;
...
/*__I  uint32_t  CODEPAGESIZE; */                   /*!< Code memory page size in bytes.                                       */
  __IO uint32_t  CODEPAGESIZE;                      /*!< Code memory page size in bytes.                                          */
  ...
  __I  uint32_t  SIZERAMBLOCK0;                     /*!< Size of RAM block 0 in bytes.                                         */
  __I  uint32_t  SIZERAMBLOCK1;                     /*!< Size of RAM block 1 in bytes.                                         */
  __I  uint32_t  SIZERAMBLOCK2;                     /*!< Size of RAM block 2 in bytes.                                         */
  __I  uint32_t  SIZERAMBLOCK3;                     /*!< Size of RAM block 3 in bytes.                                         */
  __I  uint32_t  RESERVED3[5];
  __I  uint32_t  CONFIGID;                          /*!< Configuration identifier.                                             */
  __I  uint32_t  DEVICEID0;                         /*!< Device identifier, bits 31 to 0.                                      */
  __I  uint32_t  DEVICEID1;                         /*!< Device identifier, bits 63 to 32.                                     */
  __I  uint32_t  RESERVED4[6];
  __I  uint32_t  ER0;                               /*!< Encryption root, bits 31..0.                                          */
  __I  uint32_t  ER1;                               /*!< Encryption root, bits 63..32.                                         */
  __I  uint32_t  ER2;                               /*!< Encryption root, bits 95..64.                                         */
  __I  uint32_t  ER3;                               /*!< Encryption root, bits 127..96.                                        */
  __I  uint32_t  IR0;                               /*!< Identity root, bits 31..0.                                            */
  __I  uint32_t  IR1;                               /*!< Identity root, bits 63..32.                                           */
  __I  uint32_t  IR2;                               /*!< Identity root, bits 95..64.                                           */
  __I  uint32_t  IR3;                               /*!< Identity root, bits 127..96.                                          */
  __I  uint32_t  DEVICEADDRTYPE;                    /*!< Device address type.                                                  */
  __I  uint32_t  DEVICEADDR0;                       /*!< Device address, bits 31..0.                                           */
  __I  uint32_t  DEVICEADDR1;                       /*!< Device address, bits 63..32.                                          */
} NRF_FICR_Type;
...
/* ================================================================================ */
extern NRF_GPIO_Type   * get_nrf_gpio(void);
extern NRF_GPIOTE_Type * get_nrf_gpiote(void);
extern NRF_UART_Type   * get_nrf_uart0(void); 
extern NRF_NVMC_Type   * get_nrf_nvmc(void);
extern NRF_FICR_Type   * get_nrf_ficr(void);
#define NRF_POWER                       ((NRF_POWER_Type          *) NRF_POWER_BASE)
#define NRF_CLOCK                       ((NRF_CLOCK_Type          *) NRF_CLOCK_BASE)
#define NRF_MPU                         ((NRF_MPU_Type            *) NRF_MPU_BASE)
#define NRF_RADIO                       ((NRF_RADIO_Type          *) NRF_RADIO_BASE)
#define NRF_UART0                       (get_nrf_uart0())
#define NRF_SPI0                        ((NRF_SPI_Type            *) NRF_SPI0_BASE)
#define NRF_TWI0                        ((NRF_TWI_Type            *) NRF_TWI0_BASE)
#define NRF_SPI1                        ((NRF_SPI_Type            *) NRF_SPI1_BASE)
#define NRF_TWI1                        ((NRF_TWI_Type            *) NRF_TWI1_BASE)
#define NRF_GPIOTE                      (get_nrf_gpiote())
...
#define NRF_NVMC                        (get_nrf_nvmc())
#define NRF_PPI                         ((NRF_PPI_Type            *) NRF_PPI_BASE)
#define NRF_FICR                        (get_nrf_ficr())
#define NRF_UICR                        ((NRF_UICR_Type           *) NRF_UICR_BASE)
#define NRF_GPIO                        (get_nrf_gpio())
