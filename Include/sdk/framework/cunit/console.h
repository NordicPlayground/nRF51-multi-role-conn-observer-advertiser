...
#define CONSOLE_NEWLINE_LF_NUMERIC    "\x0A"      /* \r and \n do not equal these values. */
/* Default newline style */
#define CONSOLE_NEWLINE_DEFAULT       CONSOLE_NEWLINE_CRLF_NUMERIC  
...
/** \brief Print the hexadecimal ASCII representation of a double word (four octets)
 * 
 * \param w A double word (32-bits, four octets)
 */
void console_put_hexdword(uint32_t w);
